...
<div class="navbar-admin">
  ...
  <div class="navbar links-admin">
    ...
    <a class="button" href="/admin/cerrar-sesion.php">Cerrar Sesion</a>
  </div>
</div>
...
<section class="contenedor">
  <h1>Crear Reporte</h1>
  <form action="/admin/reportes/crear.php" class="formulario" method="POST" enctype="multipart/form-data">
    <?php include __DIR__ . '/../../templates/formularioReportes.php'; ?>
